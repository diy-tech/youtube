class BinaryTreeAsList:
    ...
    def preorderTraversal(self):
        """!
        Invokes the preorder traversal on the tree.
        Returns a list of nodes in preorder traversal.
        """
        return self.__preorderTraversalRec(self.__root)

    def __preorderTraversalRec(self, node):
        ...
        result.append(node)
        if node.left != None:
            result.extend(self.__preorderTraversalRec(node.left))
        if node.right != None:
            result.extend(self.__preorderTraversalRec(node.right))
        return result
...
if __name__ == "__main__":
    ...
    for node in binTree.preorderTraversal():
        print(node.value)
